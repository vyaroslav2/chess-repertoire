...
**Also affects:** [[A1.02]] (the same step drawn in A1), [[R.03]] (the lockfile step it happens before), [[intentions/R/R.06]] (which sends later messages to this same file)
